...
execute unless score data brainfuck matches 0 run function brainfuck:loop_18
function brainfuck:dec_ptr
function brainfuck:dec_ptr
function brainfuck:load
execute unless score data brainfuck matches 0 run function brainfuck:loop_20
